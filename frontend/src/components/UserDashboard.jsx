  ...
  return (
    <div className="w-screen min-h-screen flex flex-col gap-5 items-center bg-[#fff9f6] overflow-y-auto">
      ...
      <div className="w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]">
        ...
        <div className="relative max-w-full">
          ...
          >
            ...
            {shopsOfCity?.length ==0 && <div className='w-screen bg-gray-200 h-auto'>
              <p className='text-center font-bold text-gray-700 p-[10px] w-full text-[20px]'>☹️ Sorry , There are no shops found in your current city.</p>
              <p className='text-center font-bold text-gray-700 p-[10px] w-full text-[20px]'>We will start deliverying in your city soon......</p>
              </div>
             }
          </div>
          {showShopRight && (
      ...
      <div className="w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]">
        ...
        {updatedItemsList?.length === 0 && <div className='w-screen bg-gray-200 h-auto'>
